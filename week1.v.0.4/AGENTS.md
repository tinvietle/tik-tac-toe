...
2. Assume that the Main class of the application is called TerminalTTTBasic, generate automation test scripts in Java(JUnit) for the identified test scenarios in `test_scenarios.md`.
